...
#define NL_CONTRAST 0.8             // 0.3 low ~ 2.0 high
...
#define NL_MIST_DENSITY_DAWN 0.648      // 0.0 no mist ~ 1.0 misty
#define NL_MIST_DENSITY_DAY 0.18      // 0.0 no mist ~ 1.0 misty
#define NL_MIST_DENSITY_NIGHT 0.18      // 0.0 no mist ~ 1.0 misty
#define NL_RAIN_MIST_OPACITY 0.12 // [toggle] 0.04 very subtle ~ 0.5 thick rain mist blow
//#define NL_CLOUDY_FOG          // [toggle] 0.0 subtle - 0.8 dense fog clouds
#define NL_CLOUDY_FOG_DAWN 0.25         // [toggle] 0.0 subtle - 0.8 dense fog clouds
#define NL_CLOUDY_FOG_DAY 0.00         // [toggle] 0.0 subtle - 0.8 dense fog clouds
#define NL_CLOUDY_FOG_NIGHT 0.00          // [toggle] 0.0 subtle - 0.8 dense fog clouds

/* Sky colors - zenith=top, horizon=bottom */
#define NL_DAY_ZENITH_COL    vec3(0.15,0.35,1.0)
#define NL_DAY_HORIZON_COL   vec3(0.53,0.83,0.93)
#define NL_NIGHT_ZENITH_COL  vec3(0.01,0.02,0.08)
#define NL_NIGHT_HORIZON_COL vec3(0.1,0.2,0.4)
...
#define NL_RAINBOW_CLEAR 1.7 // 0.3 subtle ~ 1.7 bright during clear
...
#define NL_SHOOTING_STAR_REFL
#define NL_ROUNDED_CLOUD_REFL
//#define NL_SUN_REFL
#define NL_FAKE_SUN_ROT 45.0
#define NL_FAKE_SUN_HEIGHT 0.8
...
#define NL_CLOUD2_DENSITY_TYPE 1     // 1: Rounded, 2: fbm volumetric, 3: fracttal noise volumetric 
#define NL_CLOUD2_THICKNESS 6.1      // 0.5 slim ~ 5.0 fat
#define NL_CLOUD2_RAIN_THICKNESS 6.5 // 0.5 slim ~ 5.0 fat
...
//#define NL_LENS_FLARE
#define NL_SUN_BLOOM
#define NL_SUN_BLOOM_COL  vec3(0.1,0.1,0.1)
#define NL_MOON_BLOOM
#define NL_MOON_BLOOM_COL vec3(0.4,0.4,0.5)
...
#undef NL_CLOUD2_DENSITY_TYPE  

#define NL_CLOUD2_DENSITY_TYPE 2
#endif

#ifdef RAINBOW_IN_RAIN
#undef NL_RAINBOW_CLEAR
